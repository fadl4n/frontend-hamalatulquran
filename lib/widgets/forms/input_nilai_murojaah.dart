...
class InputNilaiMurojaah extends StatefulWidget {
  final String namaSurat;
  final Santri santri;
  final String imageUrl;
  final String gender;

  const InputNilaiMurojaah({
    super.key,
  ...
  @override
  State<InputNilaiMurojaah> createState() => _InputNilaiMurojaahState();
}

class _InputNilaiMurojaahState extends State<InputNilaiMurojaah> {
  ...
  void _handleSubmit() {
    ...
    if (nilai == null) {
      SnackbarHelper.showError(context, "Nilai harus berupa angka");
      return;
    }
    ...
    SnackbarHelper.showSuccess(context, "Evaluasi berhasil disimpan");
  }
