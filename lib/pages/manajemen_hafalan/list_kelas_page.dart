...
import 'package:frontend_hamalatulquran/pages/manajemen_hafalan/list_santri_page.dart';
...
class _ListKelasPageState extends State<ListKelasPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppbar(title: "Manajemen Hafalan", fontSize: 18.sp),
      body: Padding(
                      ...
                      return KelasTile(
                        ...
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => ListSantriPage(
                                id: kelas.id,
